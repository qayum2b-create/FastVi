...
import { Home, ShieldCheck, QrCode, Users, Building2, LogOut, Activity, ScanLine } from "lucide-react";
  ...
  return (
    <aside className="hidden md:flex md:flex-col w-64 shrink-0 border-r border-border bg-card min-h-screen p-6 gap-8">
      <div>
        ...
        <div className="label-tiny mt-2">Secure Intercom</div>
      </div>
      ...
      <div className="mt-auto">
        <div className="card-stroke p-3 mb-3">
          ...
          <div className="text-xs mt-1 inline-block px-2 py-0.5 rounded-full bg-accent text-accent-foreground uppercase tracking-widest font-bold">
            {user?.role}
          </div>
        </div>
